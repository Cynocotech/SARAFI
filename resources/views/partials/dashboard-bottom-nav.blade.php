...
<nav class="dash-bottom-nav" aria-label="منوی پایین">
  <a href="{{ route('dashboard.index') }}" class="dash-bottom-nav-item {{ request()->routeIs('dashboard.index') ? 'active' : '' }}">
  ...
  <a href="{{ route('dashboard.rates') }}" class="dash-bottom-nav-item {{ request()->routeIs('dashboard.rates') || request()->routeIs('dashboard.office-rates') ? 'active' : '' }}">
    <span class="dash-bottom-nav-icon" aria-hidden="true">
  ...
  <a href="{{ route('dashboard.rates-history') }}" class="dash-bottom-nav-item {{ request()->routeIs('dashboard.rates-history') ? 'active' : '' }}">
    <span class="dash-bottom-nav-icon" aria-hidden="true">
  ...
  <a href="{{ route('dashboard.subscription') }}" class="dash-bottom-nav-item {{ request()->routeIs('dashboard.subscription') ? 'active' : '' }}">
    <span class="dash-bottom-nav-icon" aria-hidden="true">
