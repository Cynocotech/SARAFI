<?php $__env->startSection('title', 'صفحه نمایش دیجیتال | آقای صرافی'); ?>
<?php $__env->startSection('dashboard_nav_title', 'صفحه نمایش دیجیتال'); ?>
<?php $__env->startSection('dashboard_nav_back', route('dashboard.index')); ?>
<?php $__env->startSection('content'); ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('error')): ?>
          <div style="background: var(--danger); color: white; padding: 0.75rem 1rem; border-radius: var(--radius); margin-bottom: 1rem; font-size: 0.9rem;"><?php echo e(session('error')); ?></div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="dash-card" style="margin-bottom:1.5rem;">
          ...
          <div style="display:flex;flex-wrap:wrap;align-items:center;gap:0.75rem;">
            <input type="text" id="staticTvLink" readonly value="<?php echo e(url('/tv')); ?>" style="flex:1;min-width:200px;padding:0.6rem 0.75rem;font-size:0.9rem;border:1px solid var(--border);border-radius:var(--radius);background:var(--bg-elevated);color:var(--text);">
            <button type="button" id="copyTvLink" class="btn btn-primary" style="white-space:nowrap;">کپی لینک</button>
          </div>
        </div>

        <div style="display:flex;flex-wrap:wrap;gap:0.75rem;margin-bottom:1.5rem;">
          <a href="<?php echo e(route('dashboard.signage.create')); ?>" class="btn btn-primary">افزودن صفحه نمایش</a>
        ...
        <div class="dash-card">
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($screens->isEmpty()): ?>
            <p style="color:var(--text-muted);">هنوز صفحه‌ای نساخته‌اید. با دکمهٔ بالا یک صفحه اضافه کنید.</p>
          <?php else: ?>
            <ul style="list-style:none;padding:0;margin:0;">
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $screens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $screen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li style="border-bottom:1px solid var(--border);padding:1rem 0;">
                  <div style="display:flex;flex-wrap:wrap;align-items:center;gap:0.75rem;">
                    <strong><?php echo e($screen->name ?: ('صفحه ' . $screen->id)); ?></strong>
                    <span style="font-size:0.85rem;color:var(--text-muted);">کد: <code style="background:var(--bg-elevated);padding:0.2rem 0.5rem;border-radius:4px;"><?php echo e($screen->pairing_code); ?></code></span>
                    <a href="<?php echo e($screen->getDisplayUrl()); ?>" target="_blank" rel="noopener" class="btn btn-secondary" style="padding:0.35rem 0.75rem;font-size:0.9rem;">باز کردن لینک نمایش</a>
                    <a href="<?php echo e(route('dashboard.signage.edit', $screen)); ?>" class="btn btn-secondary" style="padding:0.35rem 0.75rem;font-size:0.9rem;">ویرایش</a>
                    <form action="<?php echo e(route('dashboard.signage.destroy', $screen)); ?>" method="POST" style="display:inline-block;" onsubmit="return confirm('حذف این صفحه؟');">
                      <?php echo csrf_field(); ?>
                  ...
                  <p style="margin:0.5rem 0 0;font-size:0.8rem;color:var(--text-muted);word-break:break-all;"><?php echo e($screen->getDisplayUrl()); ?></p>
                </li>
  ...
  <script>
  (function() {
    var pairUrl = '<?php echo e(route("dashboard.signage.pair")); ?>';
      ...
      scanner.start({ facingMode: 'environment' }, { fps: 8 }, function(decodedText) {
        ...
        scanner.stop().then(function() {
          ...
          fetch(pairUrl, {
            ...
            .catch(function() {
              window.location.href = '<?php echo e(route("dashboard.signage.index")); ?>';
            });
        }).catch(function() {});
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Volumes/G-DRIVE  SSD  1TB/Exchange Landing/exchange-backend/resources/views/dashboard/signage/index.blade.php ENDPATH**/ ?>