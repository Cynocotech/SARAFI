<?php $__env->startSection('title', 'پنل مدیریت صرافی | آقای صرافی'); ?>
<?php $__env->startSection('content'); ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('success')): ?>
          <div style="background: var(--success); color: white; padding: 0.75rem 1rem; border-radius: var(--radius); margin-bottom: 1rem; font-size: 0.9rem;"><?php echo e(session('success')); ?></div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($subscriptionActive) && !$subscriptionActive): ?>
          <div class="subscription-alert">
            ...
            <a href="<?php echo e(route('dashboard.subscription')); ?>" style="color: inherit; font-weight: 700; text-decoration: underline; white-space: nowrap;">رفتن به صفحه اشتراک</a>
          </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        <?php
          $gbpRate = $office instanceof \App\Models\ExchangeOffice
            ? $office->exchangeRates->where('from_currency','GBP')->where('to_currency','IRR')->first()
            : null;
          $statsProps = [
            'subscriptionActive' => $subscriptionActive ?? false,
            'planName'           => $planName ?? '',
            'daysRemaining'      => $subscriptionDaysRemaining ?? null,
            'gbpBuyRate'         => $gbpRate?->buy_rate,
            'gbpSellRate'        => $gbpRate?->sell_rate,
          ];
        ?>
        <div id="dashboard-stats-app" data-props="<?php echo e(json_encode($statsProps)); ?>"></div>
        <?php echo app('Illuminate\Foundation\Vite')(['resources/js/pages/dashboard-home.js']); ?>
          ...
          <div class="dashboard-grid info-with-notice">
            <div class="dash-card" style="padding:0;">
              <div class="office-info-card">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($office && ($office->identity_verified || $office->status === \App\Models\ExchangeOffice::STATUS_ACTIVE)): ?>
                  <div class="office-info-header">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($office->logoUrl()): ?>
                      <img src="<?php echo e($office->logoUrl()); ?>" alt="" class="office-info-avatar office-info-avatar-img" width="64" height="64">
                    <?php else: ?>
                      <div class="office-info-avatar" aria-hidden="true"><?php echo e(mb_substr($office->name, 0, 1) ?: '؟'); ?></div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                  ...
                  <div class="office-info-logo-upload" style="padding:1rem 1.5rem; border-top:1px solid var(--border);">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('success')): ?>
                      <p class="logo-upload-success" style="margin:0 0 0.75rem;padding:0.5rem 0.75rem;background:rgba(16,185,129,0.15);border:1px solid rgba(16,185,129,0.4);border-radius:var(--radius);color:var(--success);font-weight:600;"><?php echo e(session('success')); ?></p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($errors->has('logo')): ?>
                      <p class="logo-upload-error" style="margin:0 0 0.75rem;padding:0.5rem 0.75rem;background:rgba(239,68,68,0.1);border:1px solid rgba(239,68,68,0.3);border-radius:var(--radius);color:var(--danger);font-weight:600;"><?php echo e($errors->first('logo')); ?></p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($errors->has('logo_url')): ?>
                      <p class="logo-upload-error" style="margin:0 0 0.75rem;padding:0.5rem 0.75rem;background:rgba(239,68,68,0.1);border:1px solid rgba(239,68,68,0.3);border-radius:var(--radius);color:var(--danger);font-weight:600;"><?php echo e($errors->first('logo_url')); ?></p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <form id="logo-fallback-form" action="<?php echo e(route('dashboard.logo.update')); ?>" method="POST" enctype="multipart/form-data" style="display:none;margin-top:0.75rem;">
                      <?php echo csrf_field(); ?>
                    ...
                    <form id="logo-url-form" action="<?php echo e(route('dashboard.logo-url.update')); ?>" method="POST" style="display:flex;flex-wrap:wrap;gap:0.5rem;align-items:center;margin-top:0.25rem;">
                      <?php echo csrf_field(); ?>
                      <input type="url" name="logo_url" id="logo-url-input" value="<?php echo e(old('logo_url', $office->logo_url ?? '')); ?>" placeholder="https://example.com/logo.png" style="flex:1;min-width:180px;padding:0.5rem 0.75rem;border:1px solid var(--border);border-radius:var(--radius);font-size:0.9rem;">
                  ...
                  <div class="office-info-body">
                    <ul class="office-info-list">
                      <li class="office-info-item">
                        ...
                        <div class="office-info-item-content">
                          ...
                          <div class="office-info-item-value"><?php echo e($office->name); ?></div>
                        </div>
                      </li>
                      <li class="office-info-item">
                        <span class="office-info-item-icon" aria-hidden="true">
                        ...
                        <div class="office-info-item-content">
                          ...
                          <div class="office-info-item-value"><?php echo e($office->address_line_1); ?>، <?php echo e($office->city); ?> <span class="postcode-uppercase"><?php echo e(strtoupper($office->postcode)); ?></span></div>
                        </div>
                      </li>
                      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($office->phone): ?>
                        <li class="office-info-item">
                          ...
                          <div class="office-info-item-content">
                            ...
                            <div class="office-info-item-value"><a href="tel:<?php echo e(preg_replace('/\s+/', '', $office->phone)); ?>" dir="ltr"><?php echo e($office->phone); ?></a></div>
                          </div>
                        </li>
                      <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($office->email): ?>
                        <li class="office-info-item">
                          ...
                          <div class="office-info-item-content">
                            ...
                            <div class="office-info-item-value"><a href="mailto:<?php echo e($office->email); ?>"><?php echo e($office->email); ?></a></div>
                          </div>
                        </li>
                      <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($office->fca_number): ?>
                        <li class="office-info-item">
                          <span class="office-info-item-icon" aria-hidden="true">
                          ...
                          <div class="office-info-item-content">
                            ...
                            <div class="office-info-item-value"><?php echo e($office->fca_number); ?></div>
                          </div>
                        </li>
                      <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($office->company_house_id): ?>
                        <li class="office-info-item">
                          <span class="office-info-item-icon" aria-hidden="true">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
                          </span>
                          <div class="office-info-item-content">
                            ...
                            <div class="office-info-item-value"><?php echo e($office->company_house_id); ?></div>
                          </div>
                        </li>
                      <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </ul>
                    <div class="office-info-landing-link" style="margin-top:1rem;padding-top:1rem;border-top:1px solid var(--border);">
                      ...
                      <div style="display:flex;flex-wrap:wrap;align-items:center;gap:0.5rem;">
                        <input type="text" id="landingPageLink" readonly value="<?php echo e(url()->route('exchanges.show', $office)); ?>" style="flex:1;min-width:180px;padding:0.5rem 0.75rem;font-size:0.85rem;border:1px solid var(--border);border-radius:var(--radius);background:var(--bg-elevated);color:var(--text);direction:ltr;">
                        <button type="button" id="copyLandingLink" class="btn btn-primary" style="white-space:nowrap;">کپی لینک</button>
                        <a href="<?php echo e(route('exchanges.show', $office)); ?>" target="_blank" rel="noopener" class="btn btn-secondary" style="white-space:nowrap;">باز کردن</a>
                      </div>
                    </div>
                ...
                <?php else: ?>
                  <div class="office-info-body">
                    <div class="office-info-empty">
                      ...
                      <a href="<?php echo e(route('dashboard.onboarding')); ?>" class="btn-primary">ثبت صرافی</a>
        ...
        <div class="dashboard-view" id="view-rates" style="display:none;">
          <div class="dashboard-grid">
            <div class="dash-card span-2">
              ...
              <a href="<?php echo e(route('dashboard.rates')); ?>" class="btn btn-primary" style="display:inline-block;margin-top:0.75rem;">رفتن به مدیریت نرخ‌ها</a>
            </div>
        </div>
      </div>
      ...
      if (typeof Dropzone === 'undefined') {
        ...
        try {
          var dz = new Dropzone('#logo-dropzone', {
            url: '<?php echo e(route("dashboard.logo.update")); ?>',
            paramName: 'logo',
            maxFiles: 1,
            maxFilesize: 2,
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Volumes/G-DRIVE  SSD  1TB/Exchange Landing/exchange-backend/resources/views/dashboard/index.blade.php ENDPATH**/ ?>